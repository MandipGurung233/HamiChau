...
<div class="container mt-2">
        ...
        <form action="/update-product/{{$product->id}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group my-3">
                ...
                <input class="form-control" type="file" value="{{ $product->product_image}}" name="product_image" >
            </div>
            <div class="form-group my-3">
            ...
            <div class="form-group my-3">
                ...
                <input class="form-control" type="number" value="{{ $product->actual_price}}" name="actual_price" >
            </div>
            <div class="form-group my-3">
                <label for="">Discount Price</label>
                <input class="form-control" type="number" value="{{ $product->discount_price}}" name="discount_price" >
            </div>
